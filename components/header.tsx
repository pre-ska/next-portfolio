  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        ${isDark ? "bg-gray-950 border-black/40 bg-opacity-75" : ""}`}
            ...
            >
              <Link
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition",
                  {
                    ...
                    "text-gray-950 ": activeSection === link.name && !isDark,
                    "text-gray-200": activeSection === link.name && isDark,
                  }
                )}
                href={link.hash}
                onClick={() => {
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className={clsx(
                      "bg-slate-200 rounded-full absolute inset-0 -z-10",
                      {
                        "bg-gray-800": isDark,
                      }
                    )}
